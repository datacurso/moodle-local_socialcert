...
$string['ailogoalt'] = 'Logotipo de Datacurso';
$string['airegionlabel'] = 'Asistente de IA para redactar tu publicación';
...
$string['certerrordownload'] = 'Obtén primero tu certificado: descárgalo desde esta página para poder compartirlo en LinkedIn.';
$string['certerrornoorg'] = 'Compartir en LinkedIn aún no está disponible: el administrador del sitio debe configurar el ID de organización.';
$string['certificate_url']   = 'Enlace';
$string['certificateimage'] = 'certificado.png';
$string['copyarticlebuttontext'] = 'Copiar artículo de LinkedIn';
$string['copyconfirmation'] = 'Copiado ✔';
$string['copytextlabel'] = 'Copiar el texto generado';
...
$string['eventaitextgenerated'] = 'Texto de publicación generado con IA';
...
$string['nothingtoshare'] = 'Todavía no hay nada que compartir de este certificado.';
...
$string['pluginname'] = 'Compartir Certificado IA';
...
$string['socialcert:useaiassistant'] = 'Usar el asistente de IA para redactar el texto de la publicación';
$string['socialcert:viewsharepanel'] = 'Ver el panel para compartir el certificado en redes sociales';
